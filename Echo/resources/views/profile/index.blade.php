            ...
            <section id="menu-derecha" class="col-span-3 grid grid-cols-1 gap4 mt-10"> 
                ...
                <div id="myTabContent">
                            ...
                            <div class="b-radius-xl bg-color-fondo-200 my-3 p-5">
                                <h3 class="text-2xl mb-3">Información de contacto</h3>
                                    <div class="flex mt-4 space-x-3 md:mt-6">
                                        <a href="{{ route('candidatos.show', ['id' => $candidato_info->id]) }}" class="btn-principal text-white font-bold cursor-pointer">Ver perfil</a>
                                    </div>
                    ...
                    <div class="hidden p-4" id="company" role="tabpanel" aria-labelledby="dashboard-tab">
                        ...
                        @else
                            <div class="bg-color-principal flex justify-center max-w-xs py-3 b-radius-xl mb-2">
                                <h2 class="text-3xl font-bold  ">{{$usuarioActual->empresa->nombre}}</h2>
                            </div>
